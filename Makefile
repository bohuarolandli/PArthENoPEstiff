...
OBJECTS_ST=parstiff_T.f main3.0.f dlsode.f odepack1-parthenope3.0.f odepack2-parthenope3.0.f addon3.0.f
EXENAME_ST=parthenope3.0_st
...
parst: $(OBJECTS_ST)
	$(F90) $(OBJECTS_ST) -o $(EXENAME_ST) $(FLIBS) $(FOPTS)
