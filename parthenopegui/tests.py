...
class PGTestsConfig(object):
    ...
    def __init__(self):
        ...
        self.testRunDirEmpty = u"test_run_%s_empty" % self.today_ymd
        self.testRunDirDefaultSample = u"test_run_%s_sample" % self.today_ymd
        self.testRunDirFullExample = u"test_run_example_multi%s" % sys.version_info[0]
...
class TestParthenopegui(PGTestCase):
    ...
    def test_runInGUI(self):
        ...
        with patch("logging.Logger.info") as _i, patch("sys.exit") as _e, patch(
            "PySide6.QtWidgets.QApplication", return_value=self.qapp
        ) as _qa, patch(
    ...
    def test_runNoGUI(self):
        ...
        with patch("logging.Logger.info") as _i, patch("sys.exit") as _e, patch(
            ...
            pgb.runNoGUI(["a"])
            _i.assert_called_once_with(
                "Nothing to do: cannot import PySide6 and no folder to run was indicated!"
            )
...
if PGTestsConfig.test_err:
    ...
    class TestGUIErrorManager(PGTestCase):
        ...
        def test_ErrorStream(self):
            ...
            mb = MagicMock()
            with patch(
                "parthenopegui.errorManager.QMessageBox", return_value=mb, autospec=True
            ) as _mb:
                es.write("sometext")
...
if PGTestsConfig.test_con:
    ...
    class TestAskFunctions(PGTestCase):
        ...
        def test_askDirName(self):
            ...
            with patch(
                ...
                self.assertEqual(
                    askDirName(parent=None, title="mytitle", dir="/tmp"),
                    "/abc/def/ghi/",
                )
        ...
        def test_askFileName(self):
            ...
            with patch(
                ...
                self.assertEqual(
                    askFileName(
                        parent=None, title="mytitle", dir="/tmp", filter="random"
                    ),
                    "/abc/def/ghi/",
                )
    ...
    class TestPGClasses(unittest.TestCase):
        ...
        def testPGLabel(self):
            ...
            with patch("PySide6.QtWidgets.QLabel.setText", autospec=True) as _s:
    ...
    class TestNoGuiRun(PGTestCase):
        ...
        def test_prepareArgs(self):
            ...
            with patch(
                ...
                if six.PY2:
                    _g.assert_called_once_with(path)
                else:
                    _g.assert_called_once_with(path, recursive=False)
...
if PGTestsConfig.test_set:
    ...
    class TestReactionsTableWidget(PGTestCasewMainW):
        ...
        def test_fillReactions(self):
            ...
            with patch(
                "PySide6.QtWidgets.QTableWidget.resizeColumnsToContents"
            ) as _cr, patch(
                "PySide6.QtWidgets.QTableWidget.resizeRowsToContents"
            ) as _rr:
                rw.fillReactions()
    ...
    class TestResumeGrid(PGTestCasewMainW):
        ...
        def test_init(self):
            """test init"""
            with patch("PySide6.QtWidgets.QTableWidget.resizeColumnsToContents") as _rs:
    ...
    class TestConfigNuclidesOutput(PGTestCasewMainW):
        ...
        def test_init(self):
            ...
            with patch(
                ...
                _f.assert_called_once_with(cno, clear=True, addall=True)
    ...
    class TestMWRunPanel(PGTestCasewMainW):
        ...
        def test_init(self):
            ...
            with patch(
                ...
                _f.assert_called_once_with(rp, default=True)
        ...
        def test_startRunDefault(self):
            ...
            with patch(
                ...
                _p.assert_called_once_with(rp, default=True)
...
if PGTestsConfig.test_plt:
    ...
    class TestPGEmptyTableModel(PGTestCase):
        ...
        def test_flags(self):
            ...
            m = QModelIndex()
            with patch(
                "PySide6.QtCore.QModelIndex.isValid", side_effect=[False, True]
            ) as _v:
    ...
    class TestMainWindow(PGTestCasewMainW):
        ...
        def test_setIcon(self):
            ...
            with patch("parthenopegui.mainWindow.QIcon", return_value=qi) as _qi, patch(
                "PySide6.QtWidgets.QMainWindow.setWindowIcon"
            ) as _si:
                self.mainW.setIcon()
        ...
        def test_createMenusAndToolBar(self):
            ...
            with patch("PySide6.QtWidgets.QMenuBar.addMenu") as _am, patch(
            ...
            with patch("PySide6.QtWidgets.QMenu.addAction") as _aa:
                mw.createMenusAndToolBar()
