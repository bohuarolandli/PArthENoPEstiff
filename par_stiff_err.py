...
class par_stiff_err(Theory):
    ...
    def get_requirements(self):
        ...
        """
        return ['tau', 'Omega_bh2', 'dnnu', 'kappa', 'f0', 'f1', 'f2', 'f3',]
...
#            return {'B': {'kmax': requirements['A'].get('kmax', 10)}}
    ...
    def calculate(self, state, want_derived=True, **params_values_dict):
        ...
        with open('input.card', 'r') as f:
            contents = f.readlines()
        
        eta10 = 273.3036 * params_values_dict['Omega_bh2'] * (1 + 7.16958e-3*.25)
        contents.insert(1, 'TAU ' + str(params_values_dict['tau'])+'\n')
        ...
        contents.insert(6, 'RATES ' + '4 (12 3 '+str(params_values_dict['f0'])+') '
                        + '(20 3 '+str(params_values_dict['f1'])+') ' 
                        + '(28 3 '+str(params_values_dict['f2'])+') ' 
                        + '(29 3 '+str(params_values_dict['f3'])+')\n') 
        ...
        os.system('./parthenope3.0 < ' + self.parthenope_input + ' > runtime.log')
